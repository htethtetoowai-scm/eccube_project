...
// Returns the public 'Customize\Controller\ReceiptController' shared autowired service.
...
include_once $this->targetDirs[3].'\\app\\Customize\\Controller\\ReceiptController.php';

$this->services['Customize\\Controller\\ReceiptController'] = $instance = new \Customize\Controller\ReceiptController(${($_ = isset($this->services['Customize\\Repository\\ReceiptRepository']) ? $this->services['Customize\\Repository\\ReceiptRepository'] : $this->load('getReceiptRepositoryService.php')) && false ?: '_'});
