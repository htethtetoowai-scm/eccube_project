...
class EccubeProdProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->normalizedIds = [
            ...
            'customize\\controller\\receiptcontroller' => 'Customize\\Controller\\ReceiptController',
            'customize\\form\\extension\\adminproducttypeextension' => 'Customize\\Form\\Extension\\AdminProductTypeExtension',
            'customize\\repository\\receiptrepository' => 'Customize\\Repository\\ReceiptRepository',
        ...
        $this->fileMap = [
            ...
            'Customize\\Controller\\ReceiptController' => 'getReceiptControllerService.php',
            'Customize\\Form\\Extension\\AdminProductTypeExtension' => 'getAdminProductTypeExtensionService.php',
            'Customize\\Repository\\ReceiptRepository' => 'getReceiptRepositoryService.php',
            ...
            'security.request_matcher.hbiduvx' => 'getSecurity_RequestMatcher_HbiduvxService.php',
        ...
        $this->privates = [
            ...
            'Customize\\Form\\Extension\\AdminProductTypeExtension' => true,
            'Customize\\Repository\\ReceiptRepository' => true,
            ...
            'security.request_matcher.hbiduvx' => true,
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\ServiceLocator(['Customize\\Repository\\ReceiptRepository' => function () {
            return ${($_ = isset($this->services['Customize\\Repository\\ReceiptRepository']) ? $this->services['Customize\\Repository\\ReceiptRepository'] : $this->load('getReceiptRepositoryService.php')) && false ?: '_'};
    ...
    protected function getSecurity_FirewallService()
    {
        return $this->services['security.firewall'] = new \Symfony\Bundle\SecurityBundle\EventListener\FirewallListener(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap(new \Symfony\Component\DependencyInjection\ServiceLocator(['security.firewall.map.context.admin' => function () {
            ...
            yield 'security.firewall.map.context.admin' => ${($_ = isset($this->services['security.request_matcher.hbiduvx']) ? $this->services['security.request_matcher.hbiduvx'] : ($this->services['security.request_matcher.hbiduvx'] = new \Symfony\Component\HttpFoundation\RequestMatcher('^/'.$this->getEnv('string:ECCUBE_ADMIN_ROUTE').'/'))) && false ?: '_'};
